    ...
    <div class="row">
        <div class="col-md-9">
            <div class="panel panel-danger" style="direction: rtl;border:none">
                <div class="panel-heading" style="background: #ff5c59 !important;color: #fff !important;">
                    <h3 style="color:inherit">عقار غير مفعل</h3>
                </div>
                <div class="panel-body">
                    <div class="alert alert-default">
                        <p style="text-align:center;color:#ea2b2b">
                            <strong>
                            لم يتم بعد الموافقة على ظهور معاملتك في الموقع
                                سيتم مراجعة طلبك في مدة لا تتعدى 24 ساعة
                            </strong>
                        </p>
                    </div>
                </div>
