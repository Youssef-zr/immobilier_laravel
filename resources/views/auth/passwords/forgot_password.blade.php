...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <p class="login-box-msg">{{ trans('admins/admin.message_enter') }}</p>

    <form action="{{adminUrl('forgot/password')}}" method="post">
        {{ csrf_field() }}
      <div class="form-group has-feedback">
        <input type="email" name='email' class="form-control" placeholder="{{trans('admins/admin.email_placeholder')}}">
    ...
    <a href="{{adminUrl('login')}}" class="text-center">{{ trans('admins/admin.login') }}</a>
